# NLT-DEV-OTOI — agents Developer Operations & Team Orientation Index

**Document ID:** ORG-DEV-OTOI-1.0.0  
**Scope:** Repository-specific (NeuroLift-Technologies/agents)  
**Repository:** `NeuroLift-Technologies/agents`  
